...
router.get('/entry/publish', authorController.author_entry_publish_get);
router.put('/entry/:id/publish', authorController.author_entry_publish_put);
router.get('/entry/unpublish', authorController.author_entry_unpublish_get);
router.put('/entry/:id/unpublish', authorController.author_entry_unpublish_put);
